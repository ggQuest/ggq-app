...
import { classNames, noop } from "@/lib/utils/index";
    ...
    <div className={classNames("inline-block", state === "disabled" && "cursor-not-allowed")}>
      <a
        className={classNames(
          size === "normal" && "p-4 rounded-md	 leading-3",
          size === "large" && "px-6 py-4 uppercase rounded-md	",
          size === "small" && "p-2 leading-4 rounded-md	 leading-2",
          type === "primary" &&
            state === "enabled" &&
