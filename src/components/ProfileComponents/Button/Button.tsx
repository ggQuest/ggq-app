  ...
  if (variant === 'primary') {
    return (
      <BaseButton
        onClick={onClick}
        disabled={disabled}
        className={`bg-gray-900  text-indigoGray-5 hover:bg-indigoGray-70 active:text-indigoGray-30  disabled:bg-indigoGray-30 ${className}`}
        size={size}
      >
        {children}
      </BaseButton>
  ...
  if (variant === 'secondary') {
    return (
      <BaseButton
        onClick={onClick}
        disabled={disabled}
        className={`border-[1px] bg-gray-900  border-indigoGray-90 bg-white text-indigoGray-90 hover:border-indigoGray-70 hover:text-indigoGray-70 active:border-indigoGray-80 active:text-indigoGray-80 disabled:border-indigoGray-30 disabled:text-indigoGray-30 ${className}`}
        size={size}
      >
        {children}
      </BaseButton>
